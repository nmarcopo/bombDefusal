function ButtonsAnswer = ButtonRules(Bomb)
% ButtonRules
...
% For this discussion, the first button is the top-left button, the second
% button is the top-right button, the third button is the bottom-left
% button, and the fourth button is the bottom-right button.

% For example, with array input Bomb.x = [ 1  2 3 4], the 1st button (top-left) has a
% value of 1 (and color red), the 2nd button (top-right) has a value of 2 (and color
% black), etc.
...
% Adjacent is defined as only being adjacent left-to-right. Up and down is
...
if redBlue && ~sameColor
    ...
    % Check which position the blue light (value 3) is in in array "Bomb.y"
