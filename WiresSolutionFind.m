function WiresSolution = WiresSolutionFind(Bomb)
%% Wire rules
...
%% Five wire object
    ...
    elseif WireOrder(3) == 5
            ...
            % if the blue wire is second, cut the blue wire
            ...
            % if the blue wire is fifth cut blue and look at the other wires
